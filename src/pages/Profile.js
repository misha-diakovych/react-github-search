...
export const Profile = ({match}) => {
    ...
    if (loading) {
        return <p className='text-center'>Download...</p>
    }

    const {
        name, company, avatar_url, location,
        bio, login, blog, html_url, followers, following,
        public_repos, public_gists
    } = user

    return (
        <Fragment>
            <Link to='/' className='btn btn-link'>Return to main page</Link>
                ...
                <div className="card-body">
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            <div className="badge badge-success mr-1">Followers: {following}</div>
